...
pub const pmNoError: c_int = 0;
pub const pmNoData: c_int = 0;
pub const pmGotData: c_int = 1;
pub const pmHostError: c_int = -10000;
pub const pmInvalidDeviceId: c_int = -9999;
pub const pmInsufficientMemory: c_int = -9998;
pub const pmBufferTooSmall: c_int = -9997;
pub const pmBufferOverflow: c_int = -9996;
pub const pmBadPtr: c_int = -9995;
pub const pmBadData: c_int = -9994;
pub const pmInternalError: c_int = -9993;
pub const pmBufferMaxSize: c_int = -9992;
pub const pmNotImplemented: c_int = -9991;
pub const pmInterfaceNotSupported: c_int = -9990;
pub const pmNameConflict: c_int = -9989;
pub const pmDeviceRemoved: c_int = -9988;
pub const PmError = c_int;
pub extern fn Pm_Initialize() PmError;
pub extern fn Pm_Terminate() PmError;
pub const PortMidiStream = anyopaque;
pub extern fn Pm_HasHostError(stream: ?*PortMidiStream) c_int;
pub extern fn Pm_GetErrorText(errnum: PmError) [*c]const u8;
pub extern fn Pm_GetHostErrorText(msg: [*c]u8, len: c_uint) void;
pub const PmDeviceID = c_int;
pub const PmDeviceInfo = extern struct {
    structVersion: c_int = 0,
    interf: [*c]const u8 = null,
    name: [*c]u8 = null,
    input: c_int = 0,
    output: c_int = 0,
    opened: c_int = 0,
...
pub const pmKeyNone: c_int = 0;
pub const pmKeyCoreMidiManufacturer: c_int = 1;
pub const pmKeyAlsaPortName: c_int = 2;
pub const pmKeyAlsaClientName: c_int = 3;
pub const enum_PmSysDepPropertyKey = c_uint;
const struct_unnamed_1 = extern struct {
    key: enum_PmSysDepPropertyKey = @import("std").mem.zeroes(enum_PmSysDepPropertyKey),
    value: ?*const anyopaque = null,
};
pub const PmSysDepInfo = extern struct {
    structVersion: c_int = 0,
    length: c_int = 0,
    _properties: [0]struct_unnamed_1 = @import("std").mem.zeroes([0]struct_unnamed_1),
    pub fn properties(_self: anytype) __helpers.FlexibleArrayType(@TypeOf(_self), @typeInfo(@TypeOf(_self.*._properties)).array.child) {
        return @ptrCast(@alignCast(&_self.*._properties));
    }
};
pub extern fn Pm_CountDevices() c_int;
pub extern fn Pm_GetDefaultInputDeviceID() PmDeviceID;
pub extern fn Pm_GetDefaultOutputDeviceID() PmDeviceID;
pub extern fn Pm_FindDevice(pattern: [*c]u8, is_input: c_int) PmDeviceID;
pub const PmTimestamp = i32;
pub const PmTimeProcPtr = ?*const fn (time_info: ?*anyopaque) callconv(.c) PmTimestamp;
pub extern fn Pm_GetDeviceInfo(id: PmDeviceID) [*c]const PmDeviceInfo;
pub extern fn Pm_OpenInput(stream: [*c]?*PortMidiStream, inputDevice: PmDeviceID, inputSysDepInfo: ?*anyopaque, bufferSize: i32, time_proc: PmTimeProcPtr, time_info: ?*anyopaque) PmError;
pub extern fn Pm_OpenOutput(stream: [*c]?*PortMidiStream, outputDevice: PmDeviceID, outputSysDepInfo: ?*anyopaque, bufferSize: i32, time_proc: PmTimeProcPtr, time_info: ?*anyopaque, latency: i32) PmError;
pub extern fn Pm_CreateVirtualInput(name: [*c]const u8, interf: [*c]const u8, sysDepInfo: ?*anyopaque) PmError;
pub extern fn Pm_CreateVirtualOutput(name: [*c]const u8, interf: [*c]const u8, sysDepInfo: ?*anyopaque) PmError;
pub extern fn Pm_DeleteVirtualDevice(device: PmDeviceID) PmError;
pub extern fn Pm_SetFilter(stream: ?*PortMidiStream, filters: i32) PmError;
pub extern fn Pm_SetChannelMask(stream: ?*PortMidiStream, mask: c_int) PmError;
pub extern fn Pm_Abort(stream: ?*PortMidiStream) PmError;
pub extern fn Pm_Close(stream: ?*PortMidiStream) PmError;
pub extern fn Pm_Synchronize(stream: ?*PortMidiStream) PmError;
pub const PmMessage = u32;
pub const PmEvent = extern struct {
    message: PmMessage = 0,
    timestamp: PmTimestamp = 0,
};
pub extern fn Pm_Read(stream: ?*PortMidiStream, buffer: [*c]PmEvent, length: i32) c_int;
pub extern fn Pm_Poll(stream: ?*PortMidiStream) PmError;
pub extern fn Pm_Write(stream: ?*PortMidiStream, buffer: [*c]PmEvent, length: i32) PmError;
pub extern fn Pm_WriteShort(stream: ?*PortMidiStream, when: PmTimestamp, msg: PmMessage) PmError;
pub extern fn Pm_WriteSysEx(stream: ?*PortMidiStream, when: PmTimestamp, msg: [*c]u8) PmError;
...
pub const PM_DEFAULT_SYSEX_BUFFER_SIZE = @as(c_int, 1024);
pub const PmStream = PortMidiStream;
pub const PM_HOST_ERROR_MSG_LEN = @as(c_uint, 256);
pub const pmNoDevice = -@as(c_int, 1);
pub const PM_DEVICEINFO_VERS = @as(c_int, 200);
pub const PM_SYSDEPINFO_VERS = @as(c_int, 210);
pub inline fn PmBefore(t1: anytype, t2: anytype) @TypeOf((t1 - t2) < @as(c_int, 0)) {
    _ = &t1;
    _ = &t2;
    return (t1 - t2) < @as(c_int, 0);
}
pub const PM_FILT_ACTIVE = @as(c_int, 1) << @as(c_int, 0x0E);
pub const PM_FILT_SYSEX = @as(c_int, 1) << @as(c_int, 0x00);
pub const PM_FILT_CLOCK = @as(c_int, 1) << @as(c_int, 0x08);
pub const PM_FILT_PLAY = ((@as(c_int, 1) << @as(c_int, 0x0A)) | (@as(c_int, 1) << @as(c_int, 0x0C))) | (@as(c_int, 1) << @as(c_int, 0x0B));
pub const PM_FILT_TICK = @as(c_int, 1) << @as(c_int, 0x09);
pub const PM_FILT_FD = @as(c_int, 1) << @as(c_int, 0x0D);
pub const PM_FILT_UNDEFINED = PM_FILT_FD;
pub const PM_FILT_RESET = @as(c_int, 1) << @as(c_int, 0x0F);
pub const PM_FILT_REALTIME = (((((PM_FILT_ACTIVE | PM_FILT_SYSEX) | PM_FILT_CLOCK) | PM_FILT_PLAY) | PM_FILT_UNDEFINED) | PM_FILT_RESET) | PM_FILT_TICK;
pub const PM_FILT_NOTE = (@as(c_int, 1) << @as(c_int, 0x19)) | (@as(c_int, 1) << @as(c_int, 0x18));
pub const PM_FILT_CHANNEL_AFTERTOUCH = @as(c_int, 1) << @as(c_int, 0x1D);
pub const PM_FILT_POLY_AFTERTOUCH = @as(c_int, 1) << @as(c_int, 0x1A);
pub const PM_FILT_AFTERTOUCH = PM_FILT_CHANNEL_AFTERTOUCH | PM_FILT_POLY_AFTERTOUCH;
pub const PM_FILT_PROGRAM = @as(c_int, 1) << @as(c_int, 0x1C);
pub const PM_FILT_CONTROL = @as(c_int, 1) << @as(c_int, 0x1B);
pub const PM_FILT_PITCHBEND = @as(c_int, 1) << @as(c_int, 0x1E);
pub const PM_FILT_MTC = @as(c_int, 1) << @as(c_int, 0x01);
pub const PM_FILT_SONG_POSITION = @as(c_int, 1) << @as(c_int, 0x02);
pub const PM_FILT_SONG_SELECT = @as(c_int, 1) << @as(c_int, 0x03);
pub const PM_FILT_TUNE = @as(c_int, 1) << @as(c_int, 0x06);
pub const PM_FILT_SYSTEMCOMMON = ((PM_FILT_MTC | PM_FILT_SONG_POSITION) | PM_FILT_SONG_SELECT) | PM_FILT_TUNE;
pub inline fn Pm_Channel(channel: anytype) @TypeOf(@as(c_int, 1) << channel) {
    _ = &channel;
    return @as(c_int, 1) << channel;
}
pub inline fn Pm_Message(status: anytype, data1: anytype, data2: anytype) @TypeOf((((data2 << @as(c_int, 16)) & __helpers.promoteIntLiteral(c_int, 0xFF0000, .hex)) | ((data1 << @as(c_int, 8)) & __helpers.promoteIntLiteral(c_int, 0xFF00, .hex))) | (status & @as(c_int, 0xFF))) {
    _ = &status;
    _ = &data1;
    _ = &data2;
    return (((data2 << @as(c_int, 16)) & __helpers.promoteIntLiteral(c_int, 0xFF0000, .hex)) | ((data1 << @as(c_int, 8)) & __helpers.promoteIntLiteral(c_int, 0xFF00, .hex))) | (status & @as(c_int, 0xFF));
}
pub inline fn Pm_MessageStatus(msg: anytype) @TypeOf(msg & @as(c_int, 0xFF)) {
    _ = &msg;
    return msg & @as(c_int, 0xFF);
}
pub inline fn Pm_MessageData1(msg: anytype) @TypeOf((msg >> @as(c_int, 8)) & @as(c_int, 0xFF)) {
    _ = &msg;
    return (msg >> @as(c_int, 8)) & @as(c_int, 0xFF);
}
pub inline fn Pm_MessageData2(msg: anytype) @TypeOf((msg >> @as(c_int, 16)) & @as(c_int, 0xFF)) {
    _ = &msg;
    return (msg >> @as(c_int, 16)) & @as(c_int, 0xFF);
}
pub const PmSysDepPropertyKey = enum_PmSysDepPropertyKey;
